...
def reason_for(key,title):
    t=title
    if any(k in t for k in ("地震","台风","暴雨","洪涝","事故","伤亡","失联","灾害","救灾","紧急转移","滑坡","泥石流")):
...
TOP_BLOCK=["新书","研究会","会员代表大会","时装周","圆满举办","宣传周","宣传月","启动仪式","限时优惠","现金激励","ETF","减持","质押","保荐","违规被罚","实干样本","品牌活动","视频","研讨会","交流活动","道歉","市场汇价","开学典礼","体育","比赛","白鹭","早报","大赛","决赛","启幕","执法检查组","本周","日程","周历","头图"]
TOP_MAJOR={
